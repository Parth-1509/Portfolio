...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={sectionRef} className="  relative min-h-screen w-full px-6 md:px-16 py-28 md:py-36 overflow-hidden">
      <div
      ...
      <div className="mb-16">
        ...
        <h2 className="font-display text-5xl md:text-7xl text-bone">Experience</h2>
      </div>
      <div className='flex'>

        <div className="flex justify-between w-full ">
          <div className="relative max-w-3xl" ref={itemsRef}>
            ...
            <div className="flex flex-col gap-16 w-full">
              {experience.map((exp) => (
                <div key={exp.id} className="timeline-item relative pl-16 ">
                  <div
                    className="absolute left-0 top-1 w-11 h-11 rounded-full flex items-center justify-center font-mono text-[10px] text-bronze overflow-hidden"
                    style={{
                  ...
                  <h3 className="font-display text-2xl md:text-3xl text-bone mb-1">{exp.role}</h3>
        ...
        <div className=" flex sticky h-fit justify-end w-full">

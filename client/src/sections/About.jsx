    ...
    <section id="about" ref={sectionRef} className="relative min-h-screen  w-full px-6 md:px-16 py-28 md:py-36 overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="flex flex-col items-center gap-10 fade-up">
          <div className="relative flex items-center justify-center h-[420px] md:h-[500px] w-full">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-72 md:h-72 rounded-full glass overflow-hidden flex items-center justify-center">
              <div
            ...
            <div ref={orbitRef} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] md:w-[480px] md:h-[480px]">
              {skills.map((s, i) => {
        ...
        <div>
          <h2 className="font-display text-5xl md:text-6xl text-bone mb-8 fade-up">
            ...
            {stats.map((stat) => (
              <div key={stat.label} className="fade-up">
                <AnimatedCounter
                  ...
                  className="font-display text-4xl text-bronze"
                />
